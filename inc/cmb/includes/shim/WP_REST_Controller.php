...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( __( "Method '%s' must be overridden.",'Zubayer_agency' ), __METHOD__ ), '4.7' );
	}
	...
	public function get_collection_params() {
		return array(
			...
			'page'                   => array(
				'description'        => __( 'Current page of the collection.','Zubayer_agency' ),
				'type'               => 'integer',
				'default'            => 1,
			...
			'per_page'               => array(
				'description'        => __( 'Maximum number of items to be returned in result set.' ,'Zubayer_agency'),
				'type'               => 'integer',
				'default'            => 10,
				'minimum'            => 1,
				'maximum'            => 100,
			...
			'search'                 => array(
				'description'        => __( 'Limit results to those matching a string.','Zubayer_agency' ),
				'type'               => 'string',
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'        => __( 'Scope under which the request is made; determines fields present in response.','Zubayer_agency' ),
			'type'               => 'string',
